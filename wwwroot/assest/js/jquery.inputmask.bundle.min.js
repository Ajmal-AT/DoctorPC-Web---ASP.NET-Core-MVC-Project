    ...
    return a.extend(a.inputmask.defaults.aliases, {
        numeric: {
            ...
            onBeforeMask: function(b, c) {
                if ("" != c.radixPoint && isFinite(b)) b = b.toString().replace(".", c.radixPoint);
                else {
                    var d = b.match(/,/g),
                        e = b.match(/\./g);
            ...
            canClearPosition: function(b, c, d, e, f) {
                ...
                if (h && isFinite(g)) {
                    ...
                    if (!e && b.buffer) {
                        ...
                        var j = c + 1,
                            k = null == i || 0 == parseInt(i[0].replace(new RegExp(a.inputmask.escapeRegex(f.groupSeparator), "g"), ""));
                        if (k)
                    ...
                    if (i && (-1 == n || n >= c))
                        if (0 == i[0].indexOf("0")) h = i.index != c || -1 == n;
                            ...
                            var o = parseInt(i[0].replace(new RegExp(a.inputmask.escapeRegex(f.groupSeparator), "g"), "")); - 1 != n && 10 > o && "0" == f.placeholder.charAt(0) && (b.validPositions[c].input = "0", b.p = f.prefix.length + 1, h = !1)
                        }
                }
                return h
            }
